...
export class AttendeesAttestationsForEvent extends ScopedElementsMixin(LitElement) {
  ...
  renderList(hashes: Array<ActionHash>) {
    if (hashes.length === 0) return html`<span>No attendees attestations found for this event.</span>`;
